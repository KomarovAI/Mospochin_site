...
- Sections: 74 (19 local, 16 shared refs, 2 raw)
- Text words inside referenced sections: 2517
...
| Ремонт кухни ресторана: пароконвектоматы | hero | 12.0 KB | 94 | no | src/pages/remont-oborudovaniya-restorana-parokonvektomat/sections/006-hero-remont-kuhni-restorana-parokonvektomaty.html |
...
- src/pages/remont-oborudovaniya-restorana-parokonvektomat/sections/

## Checks

- npm run doctor:page -- --page remont-oborudovaniya-restorana-parokonvektomat.html
- npm run validate:site
- npm run check:site-builder
- npm run ai:semantic-diff -- --page remont-oborudovaniya-restorana-parokonvektomat.html
- npm run ai:check
