...
| --- | --- | --- | --- | --- | --- |
| Развели заявки по симптомам и узлам | pricing | 8.5 KB | 161 | no | src/pages/pishevarochnyj-kotel-datchik-temperatury/sections/015-pricing-razveli-zayavki-po-simptomam-i-uzlam.html |
...
| Оставьте заявку на диагностику | lead-form | 5.3 KB | 68 | no | src/pages/pishevarochnyj-kotel-datchik-temperatury/sections/017-lead-form-ostav-te-zayavku-na-diagnostiku.html |
| Симптом → узел → риск простоя → диагностика | mobile-contact | 5.1 KB | 103 | no | src/pages/pishevarochnyj-kotel-datchik-temperatury/sections/005-mobile-contact-simptom-uzel-risk-prostoya-diagnostik.html |
...
| Датчик температуры пищеварочного котла | mobile-contact | 2.7 KB | 37 | no | src/pages/pishevarochnyj-kotel-datchik-temperatury/sections/003-mobile-contact-datchik-temperatury-pischevarochnogo-.html |
