# Page Digest — kak-ponyat-chto-nuzhna-chistka-ventilyatsii.html

- Branch: restaurant
- Role: service
- Title: Когда нужна чистка вентиляции ресторана
- Description: Признаки загрязнения вентиляции ресторана: слабая тяга, запахи, жирный налёт, дым, шум, перегрев кухни и частые жалобы.
...
- Text words inside referenced sections: 1474
...
| --- | --- | --- | --- | --- | --- |
| Как понять, что нужна чистка вентиляции | breadcrumb | 58.7 KB | 1474 | no | src/pages/kak-ponyat-chto-nuzhna-chistka-ventilyatsii/sections/002-breadcrumb-kak-ponyat-chto-nuzhna-chistka-ventilyaci.html |
...
- src/pages/kak-ponyat-chto-nuzhna-chistka-ventilyatsii/page.json
- src/pages/kak-ponyat-chto-nuzhna-chistka-ventilyatsii/sections/

## Checks

- npm run doctor:restaurant-page -- --page kak-ponyat-chto-nuzhna-chistka-ventilyatsii.html
- npm run doctor:page -- --page kak-ponyat-chto-nuzhna-chistka-ventilyatsii.html
- npm run validate:site
- npm run check:site-builder
- npm run ai:semantic-diff -- --page kak-ponyat-chto-nuzhna-chistka-ventilyatsii.html
- npm run ai:check
