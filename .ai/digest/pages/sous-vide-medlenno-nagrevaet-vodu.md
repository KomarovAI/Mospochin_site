# Page Digest — sous-vide-medlenno-nagrevaet-vodu.html

- Branch: restaurant
- Role: symptom-service
- Title: Су-вид медленно нагревает воду — причины и диагностика | MosPochin
- Description: Почему термостат sous-vide долго выходит на заданную температуру: объём ванны, теплопотери, циркуляция, накипь и диагностика нагревательного контура в Москве.
...
| --- | --- | --- | --- | --- | --- |
| Связанные симптомы | related-symptoms | 4.1 KB | 84 | no | src/pages/sous-vide-medlenno-nagrevaet-vodu/sections/100-related-symptoms.html |
| Матрица причин | cause-matrix | 3.4 KB | 129 | no | src/pages/sous-vide-medlenno-nagrevaet-vodu/sections/050-cause-matrix.html |
...
- sous-vide-medlenno-nagrevaet-vodu.html
- src/site-builder.json
- src/pages/sous-vide-medlenno-nagrevaet-vodu/page.json
- src/pages/sous-vide-medlenno-nagrevaet-vodu/sections/

## Checks

- npm run doctor:page -- --page sous-vide-medlenno-nagrevaet-vodu.html
- npm run validate:site
- npm run check:site-builder
- npm run ai:semantic-diff -- --page sous-vide-medlenno-nagrevaet-vodu.html
- npm run ai:check
