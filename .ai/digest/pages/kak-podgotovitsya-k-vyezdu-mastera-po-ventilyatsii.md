# Page Digest — kak-podgotovitsya-k-vyezdu-mastera-po-ventilyatsii.html

- Branch: restaurant
- Role: service
- Title: Как подготовиться к выезду мастера по вентиляции
- Description: Что подготовить перед выездом инженера: фото шильдика, видео шума, описание симптомов, доступ к зонту, фильтрам, щиту и вентилятору.
...
| --- | --- | --- | --- | --- | --- |
| Как подготовиться к выезду мастера по вентиляции | breadcrumb | 59.1 KB | 1459 | no | src/pages/kak-podgotovitsya-k-vyezdu-mastera-po-ventilyatsii/sections/002-breadcrumb-kak-podgotovit-sya-k-vyezdu-mastera-po-ve.html |
...
- src/pages/kak-podgotovitsya-k-vyezdu-mastera-po-ventilyatsii/page.json
- src/pages/kak-podgotovitsya-k-vyezdu-mastera-po-ventilyatsii/sections/

## Checks

- npm run doctor:restaurant-page -- --page kak-podgotovitsya-k-vyezdu-mastera-po-ventilyatsii.html
- npm run doctor:page -- --page kak-podgotovitsya-k-vyezdu-mastera-po-ventilyatsii.html
- npm run validate:site
- npm run check:site-builder
- npm run ai:semantic-diff -- --page kak-podgotovitsya-k-vyezdu-mastera-po-ventilyatsii.html
- npm run ai:check
