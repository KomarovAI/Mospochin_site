# Page Digest — remont-pishevarochnyh-kotlov-iterma.html

- Branch: restaurant
- Role: branch
- Title: Ремонт пищеварочных котлов Iterma — ТЭНы и рубашка | MosPochin
...
- src/pages/remont-pishevarochnyh-kotlov-iterma/page.json
- src/pages/remont-pishevarochnyh-kotlov-iterma/sections/

## Checks

- npm run doctor:page -- --page remont-pishevarochnyh-kotlov-iterma.html
- npm run validate:site
- npm run check:site-builder
- npm run ai:semantic-diff -- --page remont-pishevarochnyh-kotlov-iterma.html
- npm run ai:check
