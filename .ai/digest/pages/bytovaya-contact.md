...
- Sections: 18 (13 local, 0 shared refs, 2 raw)
...
| --- | --- | --- | --- | --- | --- |
| Сервисные точки и карта | contact-cta | 18.2 KB | 302 | no | src/pages/bytovaya-contact/sections/007-contact-cta-servisnye-tochki-i-karta.html |
| Когда лучше звонить, а когда писать | mobile-contact | 12.7 KB | 263 | no | src/pages/bytovaya-contact/sections/009-mobile-contact-kogda-luchshe-zvonit-a-kogda-pisat.html |
| Связаться по ремонту бытовой техники | hero | 12.0 KB | 136 | no | src/pages/bytovaya-contact/sections/005-hero-svyazat-sya-po-remontu-bytovoy-tehniki.html |
| Куда писать и звонить по бытовой технике | mobile-contact | 9.5 KB | 146 | no | src/pages/bytovaya-contact/sections/006-mobile-contact-kuda-pisat-i-zvonit-po-bytovoy-tehnik.html |
| Что лучше отправить сразу | contact-cta | 7.3 KB | 172 | no | src/pages/bytovaya-contact/sections/011-contact-cta-chto-luchshe-otpravit-srazu.html |
