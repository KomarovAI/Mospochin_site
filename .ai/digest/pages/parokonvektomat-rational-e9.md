...
- H1: Ошибка Rational E9 — ремонтный сценарий без лишнего сброса
...
| --- | --- | --- | --- | --- | --- |
| Что уточняем по Rational E9 | related-links | 14.8 KB | 396 | no | src/pages/parokonvektomat-rational-e9/sections/010-related-links-chto-utochnyaem-po-rational-e9.html |
| Ошибка Rational E9 | hero | 12.4 KB | 99 | no | src/pages/parokonvektomat-rational-e9/sections/007-hero-oshibka-rational-e9.html |
...
| Repair bridge: ошибка / симптом / бренд → диагностика → заявка | section | 7.0 KB | 111 | no | src/pages/parokonvektomat-rational-e9/sections/008a-parokonvektomat-error-intent-bridge.html |
...
- src/pages/parokonvektomat-rational-e9/sections/

## Checks

- npm run doctor:page -- --page parokonvektomat-rational-e9.html
- npm run validate:site
- npm run check:site-builder
- npm run ai:semantic-diff -- --page parokonvektomat-rational-e9.html
- npm run ai:check
