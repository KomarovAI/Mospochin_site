# Page Digest — parokonvektomat-electrolux.html
...
- Sections: 78 (24 local, 13 shared refs, 2 raw)
- Text words inside referenced sections: 2725
...
| --- | --- | --- | --- | --- | --- |
| Ремонт пароконвектоматов Electrolux Professional | hero | 11.0 KB | 97 | no | src/pages/parokonvektomat-electrolux/sections/007-hero-remont-parokonvektomatov-electrolux-professiona.html |
...
| Связанные страницы по пароконвектоматам | related-links | 10.1 KB | 173 | no | src/pages/parokonvektomat-electrolux/sections/066-related-links-svyazannye-stranicy-po-parokonvektomat.html |
| Получите понятный сценарий ремонта пароконвектомата | lead-form | 9.2 KB | 111 | no | src/components/parametric/lead-form/restaurant-parokonvektomat-b2b.template.html |
...
- src/pages/parokonvektomat-electrolux/page.json
- src/pages/parokonvektomat-electrolux/sections/

## Checks

- npm run doctor:page -- --page parokonvektomat-electrolux.html
- npm run validate:site
- npm run check:site-builder
- npm run ai:semantic-diff -- --page parokonvektomat-electrolux.html
- npm run ai:check
