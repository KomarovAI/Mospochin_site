# Page Digest — vakuumator-ne-otkachivaet-vozduh.html

- Branch: restaurant
- Role: symptom-service
- Title: Вакууматор не откачивает воздух — причины и ремонт | MosPochin
- Description: Что проверить, если камерный вакууматор не создаёт вакуум или медленно откачивает воздух. Крышка, уплотнение, масло, насос и диагностика.
...
| --- | --- | --- | --- | --- | --- |
| Связанные симптомы | related-symptoms | 4.9 KB | 98 | no | src/pages/vakuumator-ne-otkachivaet-vozduh/sections/100-related-symptoms.html |
| Форма заявки | lead-form | 3.4 KB | 33 | no | src/pages/vakuumator-ne-otkachivaet-vozduh/sections/080-lead-form.html |
...
- vakuumator-ne-otkachivaet-vozduh.html
- src/site-builder.json
- src/pages/vakuumator-ne-otkachivaet-vozduh/page.json
- src/pages/vakuumator-ne-otkachivaet-vozduh/sections/

## Checks

- npm run doctor:page -- --page vakuumator-ne-otkachivaet-vozduh.html
- npm run validate:site
- npm run check:site-builder
- npm run ai:semantic-diff -- --page vakuumator-ne-otkachivaet-vozduh.html
- npm run ai:check
