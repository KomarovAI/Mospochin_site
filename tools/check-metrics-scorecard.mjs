...
for (const output of ['llm_page_scorecard_YYYY-MM-DD.csv', 'llm_page_improvement_actions_YYYY-MM-DD.csv', 'llm_internal_link_funnel_YYYY-MM-DD.csv']) {
